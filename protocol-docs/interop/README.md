...
2. [Forms of finality](./forms_of_finality.md) — the proof used by each supported route and the role
   of imported roots.
3. [Atomic interop](../atomicity/README.md) — the L2 -> L2 commitment, finality, timeout, and recovery
   protocol.
4. [Message root](../message-root.md) — settlement aggregation and dependency-root import.
5. [Bridging](../bridging.md) — asset-router, native-token-vault, and recovery integration.
