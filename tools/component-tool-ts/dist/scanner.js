...
export function scanComponentFiles(componentsRoot, gitRoot = null) {
    if (gitRoot === null) {
    ...
    for (const match of matches) {
        ...
        // Check gitignored
        if (gitRoot && isGitignored(absPath, gitRoot))
            continue;
        result.push(absPath);
    }
    return result.sort();
}
export function resolveComponentPath(linkPath, fromFile, componentsRoot) {
